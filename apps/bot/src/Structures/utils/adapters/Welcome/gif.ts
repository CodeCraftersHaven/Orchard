import { ButtonInteraction, CacheType, GuildMember, TextChannel } from 'discord.js';
...
export const welcomeEmojis = ['💕', '👌', '🙌', '<:blush:1539134725833101322>'];

export async function sticker(interaction: ButtonInteraction<CacheType>, memberId: string) {
